Rails.application.config.middleware.use OmniAuth::Builder do
  provider :SAML, {
    ...
    :idp_sso_target_url             => "https://fs.thinkthroughmath.com/adfs/ls/wtrealm=urn:federation:omniauth", #"https://fs.thinkthroughmath.com/adfs/ls/auth/integrated/?wa=wsignin1.0&wtrealm=urn:federation:omniauth", #"https://app.onelogin.com/saml/signon/48800",    #"https://fs.thinkthroughmath.com",
